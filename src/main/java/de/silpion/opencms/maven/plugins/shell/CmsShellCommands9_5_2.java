 ...
 * @author brandt
 */
class CmsShellCommands9_5_2 implements I_CmsShellCommands {
     ...
     */
    protected CmsShellCommands9_5_2() {
    ...
    public CmsResource createFolder(String targetFolder, String folderName) throws Exception {
        if (m_cms.existsResource(targetFolder + folderName)) {
            m_shell.getOut().println("GUI_SHELL_FOLDER_ALREADY_EXISTS_1: " +  targetFolder + folderName);
            return null;
        }
