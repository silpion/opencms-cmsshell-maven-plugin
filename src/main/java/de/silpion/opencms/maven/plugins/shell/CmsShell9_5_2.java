 ...
 */
public class CmsShell9_5_2 implements I_CmsShell{
    ...
    private CmsShellCommands9_5_2 m_shellCommands;
    ...
    public void initShell(I_CmsShellCommands additionalShellCommands, PrintStream out, PrintStream err) {
        ...
        m_shellCommands = new CmsShellCommands9_5_2();
        ...
        // get all shell callable methods from the CmsShellCommands9_5_2
    ...
    private void executeCommand(String command, List<String> parameters) throws CommandExecutionException {
        ...
        // prepare to lookup a method in CmsObject or CmsShellCommands9_5_2
        ...
        if (!executed) {
            ...
            ((CmsShellCommands9_5_2)m_shellCommands).help();
        }
    }
}