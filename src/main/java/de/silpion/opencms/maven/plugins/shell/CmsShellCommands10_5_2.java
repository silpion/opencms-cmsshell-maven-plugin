...
/**
 * Accassible copy of CmsShellCommands from OpenCmsCore 10.5.2
 *
 * @author brandt
 */
public class CmsShellCommands10_5_2 implements I_CmsShellCommands {
     ...
     */
    protected CmsShellCommands10_5_2() {
    ...
    public void exportAllResources(String exportFile, boolean isReducedExportMode) throws Exception {
        ...
        CmsExportParameters params = new CmsExportParameters(
                ...
                true,
                false,
                isReducedExportMode ? CmsModule.ExportMode.REDUCED : CmsModule.ExportMode.DEFAULT);
